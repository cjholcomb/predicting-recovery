...
df_political2020 = df_political2020.set_index('State Code')
df_population2020 = pd.read_csv('data/county-population-data.csv')
df_population2020 = df_population2020.drop(0)
df_population2020 = df_population2020.set_index('State Code')
df = df_political2020.join(df_population2020,how = 'right', lsuffix = 'pop')
df_2020 = df.drop(columns = [ '2001 Gov', '2001 Legis', '2001 Fiscal', '2008 Gov', '2008 Legis', '2008 Fiscal', '2001', '2008'], axis =1)
